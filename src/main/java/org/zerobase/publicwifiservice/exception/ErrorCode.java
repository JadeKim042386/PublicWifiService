...
public enum ErrorCode {
    ...
    BOOKMARK_GROUP_INVALID(HttpStatus.BAD_REQUEST, "즐겨찾기 그룹에 대한 요청이 잘못되었습니다."),
    //Bookmark
    BOOKMARK_SAVE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "즐겨찾기 저장에 실패했습니다."),
    BOOKMARK_SAVE_CONFLICT(HttpStatus.CONFLICT, "즐겨찾기 저장 중 Optimistic Lock 충돌이 일어났습니다."),
    BOOKMARK_CANT_DELETE(HttpStatus.INTERNAL_SERVER_ERROR, "즐겨찾기 삭제에 실패했습니다."),
